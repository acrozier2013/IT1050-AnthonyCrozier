...
namespace FinalProject
{
    class Hero
    {
        ...
        public Hero(string name, string nemesis,  bool antihero)
        {
            this.Name = name;
            this.nemesis = nemesis;
            this.Antihero = antihero;
        ...
        // TODO: Problem 6 - Add an overloaded method ChargePower that has a parameter for increaseAmount.  
        //Add increaseAmount to this.PowerLevel and return the new value for this.PowerLevel (try to use a loop calling the other ChargePower)
        public void ChargePower(int increaseAmount)
        {
            this.PowerLevel = increaseAmount + PowerLevel;   
        }
    }
}